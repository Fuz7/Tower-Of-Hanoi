...
export default function StartPoint({startingPoint,endPoint,setStartingPoint,isPlaying}) {
  return (
      ...
      >
        ...
        <span
          className={`block border-t-[1px] w-full border-black 
              ...
              onClick={()=>{
                startingPoint !=='A'&& endPoint!=='A'?setStartingPoint('A'):null
              }}
        >
          <span
        ...
        <span
          ...
          onClick={()=>{
            startingPoint !=='B'&& endPoint!=='B'?setStartingPoint('B'):null
          }}
        >
          <span
        ...
        <span
          ...
          onClick={()=>{
            startingPoint !=='C'&& endPoint!=='C'?setStartingPoint('C'):null
          }}
        >
          <span
          ...
          <span
            className={`z-10 relative block
              ${startingPoint==='C' || endPoint ==='C'?'': 'hover:text-white'}  transition-all
             w-full h-full `}
          >
            C
          </span>
