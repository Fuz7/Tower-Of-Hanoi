...
export default function DiskRods({ diskNumber,startingPoint,endPoint, isPlaying,setIsPlaying, playSpeed,skipRef }) {
    ...
    <>
      ...
      rounded-t-full `}      >
        ...
        (
          ...
          ref={scope}>
            <Disks colorsArray={colorsArray} movesArray={movesArray} isPlaying={isPlaying} scope={scope} animate={animate} setIsPlaying={setIsPlaying} playSpeed={playSpeed} skipRef={skipRef}/>
          </div>
        ):null}
